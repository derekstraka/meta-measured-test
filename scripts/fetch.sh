...
REPOS="poky metaoe metaintel metaselinux metameasured metameasuredbsp"
...
METAINTEL_REV="${METAINTEL_REV-refs/remotes/origin/${branch}}"

METASELINUX_URI="git://git.yoctoproject.org/meta-selinux.git"
METASELINUX_PATH="poky/meta-selinux"
METASELINUX_REV="${METASELINUX_REV-refs/remotes/origin/${branch}}"

METAMEASURED_URI="git://github.com/flihp/meta-measured.git"
METAMEASURED_PATH="poky/meta-measured"
METAMEASURED_REV="${METAMEASURED_REV-refs/remotes/origin/${branch}}"

METAMEASUREDBSP_URI="git://github.com/flihp/meta-measured-bsp.git"
METAMEASUREDBSP_PATH="poky/meta-measured-bsp"
METAMEASUREDBSP_REV="${METAMEASUREDBSP_REV-refs/remotes/origin/${branch}}"

METAMEASUREDTEST_URI="."
METAMEASUREDTEST_PATH="poky/meta-measured-test"
...
rm -rf "${METAMEASUREDTEST_PATH}" || die "unable to clear old ${METAMEASUREDTEST_PATH}"
ln -sf "../${METAMEASUREDTEST_URI}" "${METAMEASUREDTEST_PATH}" || \
	die "unable to symlink ${METAMEASUREDTEST_PATH}"
